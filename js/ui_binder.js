function createBinderOverlay(scene) {
    ...
    const filterOptions = [
        ...
        { label: 'Face', val: 'cat_Face' }, { label: 'Hand', val: 'cat_Hand' }, { label: 'Animal', val: 'cat_Animal' }, { label: 'Food', val: 'cat_Food' }, { label: 'Cosmic', val: 'cat_Cosmic' }, { label: 'Magic', val: 'cat_Magic' }, { label: 'Sport', val: 'cat_Sport' }, { label: 'Music', val: 'cat_Music' }, { label: 'Object', val: 'cat_Object' }, { label: 'Spooky', val: 'cat_Spooky' }, { label: 'Memes', val: 'cat_Memes' }
    ];
