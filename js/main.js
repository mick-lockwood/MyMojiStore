...
function addShimmerEffect(scene, card, rarity) {
    ...
    let midBar  = scene.add.rectangle(0, 0, 25, 315, sweepColor, 0.12).setBlendMode(Phaser.BlendModes.ADD);
    let coreBar = scene.add.rectangle(0, 0, 8,  316, sweepColor, 0.20).setBlendMode(Phaser.BlendModes.ADD);
