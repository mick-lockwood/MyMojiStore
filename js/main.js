...
function addShimmerEffect(scene, card, rarity) {
    ...
    let midBar  = scene.add.rectangle(0, 0, 25, 315, sweepColor, 0.10).setBlendMode(Phaser.BlendModes.ADD);
    let coreBar = scene.add.rectangle(0, 0, 8,  316, sweepColor, 0.15).setBlendMode(Phaser.BlendModes.ADD);
