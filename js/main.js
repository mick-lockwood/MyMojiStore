...
function addShimmerEffect(scene, card, rarity) {
    ...
    let wideBar = scene.add.rectangle(0, 0, 50, 316, sweepColor, 0.02).setBlendMode(Phaser.BlendModes.ADD);
    let midBar  = scene.add.rectangle(0, 0, 25, 315, sweepColor, 0.8).setBlendMode(Phaser.BlendModes.ADD);
    let coreBar = scene.add.rectangle(0, 0, 8,  316, sweepColor, 0.25).setBlendMode(Phaser.BlendModes.ADD);
